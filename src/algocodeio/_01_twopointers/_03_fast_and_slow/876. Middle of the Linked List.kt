...
/**
    ...
    оказалось можно еще лучше решить, просто в цикле fsNode = fsNode.next.next
    т.к. fs у нас будет идти в два раза быстрее, то slNode окажется прямо на середине
    что бы в цикле не вызвать next у null элемента проверяем это предварительно в условии
